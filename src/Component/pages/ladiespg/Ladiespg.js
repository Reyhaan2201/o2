...
function Ladiespg() {
  ...
  useEffect(() => {
    axios
      .get(`http://localhost:1804/Outfitoracle/${Productcategory}/Ladies`)
      .then((res) => {
        console.log("Successfully got the ladies product category", res.data);
        setProduct(res.data);
      })
      .catch((err) => {
        console.log("Error getting the product category of ladies", err.message);
      });
  }, [Productcategory]);
