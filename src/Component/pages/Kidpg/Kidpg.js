...
function Kidpg() {
  ...
  useEffect(() => {
    axios
      .get(`http://localhost:1804/Outfitoracle/${Productcategory}/Kids`)
      .then((res) => {
        console.log("Successfully got the kids product category", res.data);
        setProduct(res.data);
      })
      .catch((err) => {
        console.log("Error getting the product category of kids", err.message);
      });
  }, [Productcategory]);
