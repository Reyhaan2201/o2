...
function Baby() {
  ...
  useEffect(() => {
    axios.get(`http://localhost:1804/Outfitoracle/${Productcategory}/Baby`)
      .then((res) => {
        console.log("Successfully got the baby product category", res.data);
        setProduct(res.data);
      })
      .catch((err) => {
        console.log("Error getting the product category of baby", err.message);
      });
  }, [Productcategory]);
